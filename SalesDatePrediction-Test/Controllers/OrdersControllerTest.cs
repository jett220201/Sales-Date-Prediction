...
namespace SalesDatePrediction_Test.Controllers
{
    public class OrdersControllerTest
    {
        ...
        public async Task GetAllOrders_ReturnsOrderList_AsJson()
        {
            ...
            {
                new Order { Id = 1, RequiredDate = new DateTime(2025, 2, 26), ShippedDate = new DateTime(2025, 2, 27), ShipName = "Ship A", ShipAddress = "Ship Address A", ShipCity = "City A", CustomerId = 1 },
                new Order { Id = 2, RequiredDate = new DateTime(2025, 2, 25), ShippedDate = new DateTime(2025, 2, 26), ShipName = "Ship B", ShipAddress = "Ship Address B", ShipCity = "City B", CustomerId = 2 },
                new Order { Id = 3, RequiredDate = new DateTime(2025, 2, 24), ShippedDate = new DateTime(2025, 2, 25), ShipName = "Ship C", ShipAddress = "Ship Address C", ShipCity = "City C", CustomerId = 1 }
            };
            ...
            Assert.Equal(new DateTime(2025, 2, 26), list[0].GetType().GetProperty("Requireddate").GetValue(list[0]));
            Assert.Equal(new DateTime(2025, 2, 27), list[0].GetType().GetProperty("Shippeddate").GetValue(list[0]));
            ...
            Assert.Equal(new DateTime(2025, 2, 25), list[1].GetType().GetProperty("Requireddate").GetValue(list[1]));
            Assert.Equal(new DateTime(2025, 2, 26), list[1].GetType().GetProperty("Shippeddate").GetValue(list[1]));
            ...
            Assert.Equal(new DateTime(2025, 2, 24), list[2].GetType().GetProperty("Requireddate").GetValue(list[2]));
            Assert.Equal(new DateTime(2025, 2, 25), list[2].GetType().GetProperty("Shippeddate").GetValue(list[2]));
        ...
        public async Task PostNewOrder_ReturnsNewOrderId_AsJson()
        {
            ...
            var testOrder = new Order { 
                Id = 1, 
                RequiredDate = new DateTime(2025, 2, 26), 
                ShippedDate = new DateTime(2025, 2, 27), 
                ShipName = "Ship A", 
                ...
                CustomerId = 1,
                EmployeeId = 1,
                OrderDate = new DateTime(2025, 2, 25),
                ShipperId = 1,
                Freight = 10
            };
            ...
            var testNewOrder = new CreateOrderDto
            {
                Order = testOrder,
            ...
            // Act
            var result = await _orderController.CreateOrder(testNewOrder);
